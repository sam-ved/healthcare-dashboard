...
import { registerPatient, assignDoctor, searchPatient, getDoctorPatients, submitConsultation, getNurseDashboard, admitPatient, dischargePatient, } from '../controllers/workflowController.js';
const router = Router();
// ===== RECEPTIONIST ROUTES =====
